        ...
        <main>
            <div className="text-center pt-8 pb-4">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    Impact score is a citation-driven editorial score. It uses relative citation rank,
                    adds a small recency bonus, and the default cutoff hides a few more provisional entries.
                </p>
            </div>
            <Timeline
